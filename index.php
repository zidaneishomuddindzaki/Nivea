            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-wrap text-left lg:text-left">
                    <div class="w-full lg:w-6/12 px-4 py-5">
                        <h4 class="text-3xl font-inter font-semibold text-black pt-5">NIVEA MEN</h4>
                    ...
                    <div class="w-full lg:w-6/12 px-4 py-7">
                        <div class="flex flex-wrap justify-center items-top mb-6">
                            <div class="w-full lg:w-4/12 px-4 ml-auto">
                                <span class="uppercase text-black text-sm font-semibold mb-2 pt-7">INFORMASI</span>
                                <ul class="list-unstyled">
                                    <li>
                                        <a class="text-black font-inter hover:text-white font-semibold block pb-2 text-sm" href="https://www.nivea.co.id/tentang-kami/syarat-penggunaan" target="_blank">Syarat Penggunaan</a>
                                    </li>
                                    <li>
                                        <a class="text-black font-inter hover:text-white font-semibold block pb-2 text-sm" href="https://www.nivea.co.id/tentang-kami/kebijakan-privasi" target="_blank">Kebijakan Privacy</a>
                                    </li>
                                    <li>
                            ...
                            <div class="w-full lg:w-4/12 px-4">
                                <span class="block uppercase text-black text-sm font-semibold mb-2">TENTANG NIVEA</span>
